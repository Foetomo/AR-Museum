...
namespace Zetcil
{
    [CustomEditor(typeof(MobileTapPosition)), CanEditMultipleObjects]
    public class MobileTapPositionEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            PositionSpeed = serializedObject.FindProperty("PositionSpeed");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isEnabled.boolValue)
            {
                ...
                EditorGUILayout.PropertyField(PositionSpeed, true);
