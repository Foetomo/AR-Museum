...
namespace Zetcil
{
    [CustomEditor(typeof(MobilePremiumController)), CanEditMultipleObjects]
    public class MobilePremiumControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isEnabled.boolValue)
            {
                ...
                MobilePremiumController.CFilterSelection st = (MobilePremiumController.CFilterSelection) ObjectSelection.enumValueIndex; 

                if (st == MobilePremiumController.CFilterSelection.ByName)
                {
                    EditorGUILayout.PropertyField(ObjectName, true);
                }
                if (st == MobilePremiumController.CFilterSelection.ByTag)
                {
